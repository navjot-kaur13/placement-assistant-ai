...
/* 📊 METRICS COLOR FIX (FORCE VISIBILITY) */
...
/* Header & Footer White Text Force */
.hero-container h1, .hero-container p, .footer-container b, .footer-container p {
    color: #ffffff !important;
}
</style>
...
<div class="hero-container" style="background: linear-gradient(135deg, #1e3a8a 0%, #0d9488 100%); padding: 30px; border-radius: 20px; text-align: center; margin-bottom: 25px;">
    ...
    <p style="margin-top: 5px; opacity: 0.9;">Precision. Accuracy. Results.</p>
</div>
""", unsafe_allow_html=True)
...
# RESULTS SECTION (FIXED BREAKDOWN)
if st.session_state.get('analyzed'):
    ...
    with tabs[0]:
        ...
        # Restore the specific numbers (30, 20, 9, 15 style)
